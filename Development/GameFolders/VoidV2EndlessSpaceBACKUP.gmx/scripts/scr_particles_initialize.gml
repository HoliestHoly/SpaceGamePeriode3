...
part_type_alpha3(partType[1], 0, 1, 0);
...
part_type_life(partType[3], 300, 500);
part_type_color1(partType[3], c_white);
part_type_alpha3(partType[3], 0, 1, 0);
...
part_type_life(partType[5], 1000, 2000);
part_type_color1(partType[5], c_white);
part_type_sprite(partType[5], spr_cloud, false, true, true);
part_type_alpha3(partType[5], 0, 1, 0);

// create particles
partEmitter[1] = part_emitter_create(partSys[1]);
part_emitter_stream(partSys[1], partEmitter[1], partType[1], 2);
partEmitter[2] = part_emitter_create(partSys[1]);
part_emitter_stream(partSys[1], partEmitter[2], partType[4], -10);
partEmitter[4] = part_emitter_create(partSys[1]);
part_emitter_stream(partSys[1], partEmitter[4], partType[5], -15);
...
if room = MENU {
    ...
    part_emitter_stream(partSys[1], partEmitter[3], partType[3], 5);
}
